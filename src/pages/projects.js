...
const Projects = () => {
    return (react_1.default.createElement("div", { className: "m-4 p-4 grid gap-4 sm:grid-cols-1" },
        react_1.default.createElement(page_title_1.default, { title: "Experiences" }),
        react_1.default.createElement("div", null,
            projects.map((project, index) => (react_1.default.createElement("div", { key: index, className: `grid gap-1 sm:grid-cols-3 p-4 text-left overflow rounded-lg shadow-lg` },
                react_1.default.createElement("div", { className: "col-span-1 " },
                    react_1.default.createElement("div", { className: "text-2xl font-thin" }, project.title),
                    react_1.default.createElement("div", { className: "txet-xl font-bold" }, project.company),
                    react_1.default.createElement("ul", { className: "ml-4 list-disc text-left line-clamp-3 hover:line-clamp-none lg:line-clamp-none" }, project.description.map((line, i) => (react_1.default.createElement("li", { key: i }, line))))),
                react_1.default.createElement("div", { className: "col-span-1 mx-auto my-auto" },
                    react_1.default.createElement("img", { src: project.url, alt: "", className: "object-cover rounded-full size-40" })),
                react_1.default.createElement("div", { className: "col-span-1 py-auto" },
                    react_1.default.createElement("div", { className: "text-xl font-bold" }, "Technologies Used"),
                    react_1.default.createElement("div", { className: "text-left" }, project.technologies.map((item, index) => (react_1.default.createElement("span", { key: index, className: "inline-block bg-secondary-200 shadow-lg shadow-gray-500/40 rounded-full px-3 py-1 text-sm font-semibold text-gray-700 mr-2 my-2" },
                        "#",
                        item)))),
                    react_1.default.createElement("div", { className: "text-xl font-bold my-4" }, "Achievements & Outcomes"),
                    react_1.default.createElement("ul", { className: "ml-4 list-disc text-left" }, project.outcomes.map((outcome, i) => (react_1.default.createElement("li", { key: i }, outcome)))))))),
            react_1.default.createElement("div", null))));
};
